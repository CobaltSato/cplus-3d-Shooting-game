...
bool GameEngine::Initialize()
{
	...
	mSimpleAudio = new SimpleAudio();

	return true;
}

void GameEngine::CreateRtvAndDsvDescriptorHeaps()
{
}
...
void GameEngine::UpdateCubeMapFacePassCBs()
{
	for (int i = 0; i < 6; ++i)
	{
...
void GameEngine::LoadTextures(std::vector<std::string> texNames,
...
void GameEngine::BuildCubeDepthStencil()
{
...
void GameEngine::DrawSceneToCubeMap()
{
...
void GameEngine::BuildCubeFaceCamera(float x, float y, float z)
{
