//***************************************************************************************
// GameEngine.cpp by Frank Luna (C) 2015 All Rights Reserved.
// modified : Cobalt Sato
//***************************************************************************************
...
protected:
	...
	void LoadTextures(std::vector<std::string> texNames, std::vector<std::wstring> texFilenames);
